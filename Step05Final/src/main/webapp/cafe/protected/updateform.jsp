...
<body>
    ...
    <div class="card">
        <div class="card-body">
            <h3 class="card-title">글 수정하기</h3>
            <form action="update.jsp" method="post">
                <div class="mb-3">
                    <label for="num" class="form-label">번호</label>
                    <input type="text" name="num" value="<%=dto.getNum() %>" class="form-control" readonly/>
                </div>
                <div class="mb-3">
                    <label for="writer" class="form-label">작성자</label>
                    <input type="text" name="writer" value="<%=dto.getWriter() %>" class="form-control" readonly/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea style="width:100%" name="content" id="content" class="form-control" cols="30" rows="10"><%=dto.getContent() %></textarea>
                </div>
                <div class="mb-3">
                    <label for="viewCount" class="form-label">조회수</label>
                    <input type="text" name="viewCount" value="<%=dto.getViewCount() %>" class="form-control" readonly/>
                </div>
                <div class="mb-3">
                    <label for="regdate" class="form-label">작성일</label>
                    <input type="text" name="regdate" value="<%=dto.getRegdate() %>" class="form-control" readonly/>
                </div>
                <button type="submit" class="btn btn-primary" onclick="submitContents(this)">수정하기</button>
