...
<body>
    ...
    <div class="card">
        <div class="card-body">
            <h3 class="card-title">새로운 글 작성</h3>
            <form action="insert.jsp" method="post">
                <div class="mb-3">
                    <label for="writer" class="form-label">작성자</label>
                    <input type="text" name="writer" value="<%= writer %>" class="form-control" readonly/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea style="width:100%" name="content" id="content" class="form-control" cols="30" rows="10"></textarea>
                </div>
                <button type="button" class="btn btn-primary" onclick="submitContents(this)">등록하기</button>
            </form>
        </div>
    </div>
</div>
